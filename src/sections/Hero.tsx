  ...
  return (
    <div className="w-[70%] h-[400px] mx-auto flex justify-between px-8">
      <div className="hero-left-wrapper flex flex-col justify-evenly h-full -space-y-2">
        ...
        <span className="text-white font-dm-sans text-xs block">Custom-built resumes that match your goals, keywords, and <br></br> recruiter expectations.</span>
        <PrimaryButton>
      ...
      <div className="hero-right-wrapper flex items-center justify-center">
        <div className="hero-letter-wrapper relative">
            <img src="/hero-asset-1.png" alt="Hero E-Book" className="block h-[390px]" />
            <a className="absolute group -bottom-2 -right-8 w-[80px] h-[80px] bg-white/10 flex items-center justify-center rounded-full backdrop-blur-[14px] border-1 border-white" href="#">
            ...
            <div className="bg-red-50/0 relative -bottom-8">
                <span className="text-center text-white text-xs font-dm-sans block  mx-auto">Download Free E-Book</span>
            </div>
        </div>
      </div>
    </div>
